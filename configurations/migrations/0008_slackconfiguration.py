...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('configurations', '0007_alter_extensions_validity'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='slack_configuration', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
