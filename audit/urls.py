...
urlpatterns = [
    path("get-tags-list/", views.get_asset_tag_list, name="get_asset_tag_list"),
    ...
    path(
        "get-assigned-user/<str:tag>/",
        views.get_assigned_user,
...
audit_api_url_patterns = [
    # api urls
    path(
        "api/audit/list/completed/",
        api_views.CompletedAuditList.as_view(),
        name="complete_audit_list",
    ),
    path(
        "api/audit/list/pending/",
        api_views.PendingAuditList.as_view(),
        name="pending_audit_list",
    ),
    path("api/audit/add", api_views.AddAudit.as_view(), name="add_audit"),
    path(
        "api/audit/<str:id>", api_views.GetAuditById.as_view(), name="get_audit_by_id"
    ),
    path(
        "api/audit/details/<str:id>",
        api_views.GetAuditDetails.as_view(),
        name="audit_details",
    ),
    path(
        "api/audit/get-tags-list-api/",
        api_views.GetAssetTagList.as_view(),
        name="get_asset_tag_list_api",
    ),
    path(
        "api/audit/get-assigned-user/<str:tag>/",
        api_views.GetAssignedUser.as_view(),
        name="get_assigned_user_api",
    ),
