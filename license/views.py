...
def add_license(request):
    ...
    return render(
        request,
        "license/add_license.html",
        context={"form": license_form, "title": "Add License", "sidebar": "license"},
    )
...
def update_license(request, id):
    ...
    return render(
        request,
        "license/update-license.html",
        context={
            "form": license_form,
            "title": f"Update-{get_license.name}",
            "sidebar": "license",
        },
    )
