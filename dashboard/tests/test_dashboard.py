...
class Asseto_test_location(TestCase):
    def setUp(self):
        ...
        self.product_type = ProductType.objects.create(
            name="Type 1", organization=self.edit_organization
        )
...
class EditDepartmentTest(TestCase):
    def setUp(self):
        ...
        self.department = Department.objects.create(
            ...
            contact_person_email="contactperson1@example.com",
    ...
    def test_edit_department_organization(self):
        ...
        new_organization = Organization.objects.create(
            ...
            email="neworganization@example.com",
            phone="5556667777",
        )
        ...
        self.assertEqual(
            self.department.organization.email, "neworganization@example.com"
        )
...
class EditProductTypeTest(TestCase):
    def setUp(self):
        ...
        self.product_type = ProductType.objects.create(
            name="Product Type 1", organization=self.organization
        )
...
class EditProductCategoryTest(TestCase):
    def setUp(self):
        ...
        self.product_category = ProductCategory.objects.create(
            name="Product Category 1", organization=self.organization
        )
...
class TestEditLocation(TestCase):
    def setUp(self):
        ...
        self.product_type = ProductType.objects.create(
            name="Type 1", organization=self.organization
        )
    ...
    def test_delete_product_category(self):
        ...
        organization = Organization.objects.get(
            id=self.product_category.organization.id
        )
        self.assertIsNotNone(organization)
