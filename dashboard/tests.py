...
contact_person_phone='1112223333', organization=self.organization)
    ...
    def test_edit_department_with_new_name_and_same_organization(self):
        # Edit the department with a new name and same organization
        self.department.name = 'New Department Name'
        self.department.save()
