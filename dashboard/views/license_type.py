...
def license_type_add(request):
    ...
    return render(
        request,
        "dashboard/license_type/license-type-modal.html",
        {
...
def update_license_type(request, id):
    ...
    return render(
        request, "dashboard/license_type/license-type-modal.html", context=context
    )
...
def search_license_type(request, page):
    page_object, _, license_type_count, _ = get_license_type_list(
        request, page_number=page
    )
    return render(
        request,
        "dashboard/license_type/license-types-data.html",
        {"page_object": page_object, "license_type_count": license_type_count},
    )
