...
import json
from .api_utils import get_searched_data
...
class ProductList(APIView):
    ...
    def get(self, request):
        try:
            product_queryset = Product.undeleted_objects.filter(
            ...
            return api_response(
                data=paginated_data, message="Product list fetch successfully"
            )
...
class SearchProduct(APIView):
    ...
    def get(self, request):
        try:
            ...
            searched_product_data = get_searched_data(request, search_text)
            return api_response(
                data=searched_product_data, message="Product found successfully"
            )
        except ValueError as e:
