...
class Asseto_test(TestCase):
    def setUp(self):
        ...
        self.product_sub_category=ProductCategory.objects.create(
            name="Category 1",
        ...
        self.updated_product_sub_category=ProductCategory.objects.create(
            name="Category 2",
            organization=self.user_organization,
        )
        self.updated_product=Product.objects.create(
            ...
            product_sub_category = self.updated_product_sub_category,
    ...
    def test_product(self):
        ...
        self.assertEqual(self.product.product_sub_category.name, "Category 1")
...
class DeleteProduct(TestCase):
    def setUp(self):
        ...
        product_sub_category=ProductCategory.objects.create(
            name="Category 1",
    ...
    def test_edit_porduct(self):
        ...
        self.product.product_sub_category.name="Category 2"
        ...
        self.assertEqual(self.product.product_sub_category.name,"Category 2")
    ...
    def del_product(self):
        ...
        product_sub_category=ProductCategory.objects.get(id=self.product.product_sub_category.id)
        ...
        self.assertIsNotNone(product_sub_category)
