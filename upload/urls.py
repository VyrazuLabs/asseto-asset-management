...
urlpatterns = [
    ...
    path('vendors/search/<str:page>', views.search_vendor_upload, name='search_vendor_upload'),
    ...
    path('locations/search/<str:page>', views.search_location_upload, name='search_location_upload'),
    ...
    path('product-types/search/<str:page>', views.search_product_type_upload, name='search_product_type_upload'),
    ...
    path('product-categories/search/<str:page>', views.search_product_category_upload, name='search_product_category_upload'),
    ...
    path('departments/search/<str:page>', views.search_department_upload, name='search_department_upload'),
    ...
    path('users/search/<str:page>', user_views.search_user_upload, name='search_user_upload'),
