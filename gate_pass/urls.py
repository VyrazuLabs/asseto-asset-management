...
urlpatterns = [
    ...
    path("search", views.filter_and_search, name="search"),
...
gate_pass_api_url_patterns = [
    path(
        "api/gate-pass/list", api_views.GatePassList.as_view(), name="list_gate_passes"
    ),
    path(
        "api/gate-pass/search",
        api_views.GatePassSearch.as_view(),
        name="search_gate_passes",
    ),
    path(
        "api/gate-pass/create",
        api_views.GatePassCreate.as_view(),
        name="create_gate_pass",
    ),
    path(
        "api/gate-pass/approve/<str:gate_pass_id>",
        api_views.GatePassApprove.as_view(),
