...
urlpatterns = [
    ...
    path(
        "update-assets-details/<str:id>/",
        views.update_in_detail,
        name="update_in_detail",
    ),
    ...
    path(
        "delete-assign-asset-list/<uuid:id>",
        views.delete_assign_asset_list,
        name="delete_assign_asset_list",
    ),
    path(
        "assign-asset-in-asset-list/<uuid:id>",
    ...
    # urls for pie chart
    path(
        "piechart_status_data/",
        views.pie_chart_assigned_status,
        name="piechart_status_data",
    ),
    ...
    path(
        "asset_status_list",
        asset_status_views.asset_status_list,
        name="asset_status_list",
    ),
    path(
        "asset_status_details/<uuid:id>",
        asset_status_views.asset_status_details,
        name="asset_status_details",
    ),
    path(
        "edit_asset_status/<uuid:id>",
        asset_status_views.edit_asset_status,
        name="edit_asset_status",
    ),
    path(
        "asset_status_search/<str:page>",
        asset_status_views.asset_status_search,
        name="asset_status_search",
    ),
    path(
        "delete_asset_status/<uuid:id>",
        asset_status_views.delete_asset_status,
...
api_url_patterns = [
    ...
    path(
        "api/asset/details/<uuid:id>/",
        api_views.AssetDetails.as_view(),
        name="asset_details",
    ),
    path(
        "api/asset/update/<uuid:id>",
        api_views.UpdateAsset.as_view(),
        name="update_asset",
    ),
    path(
        "api/asset/delete/<uuid:id>",
        api_views.DeleteAsset.as_view(),
        name="delete_asset",
    ),
    path("api/asset/search/", api_views.SearchAsset.as_view(), name="search_asset"),
    path(
        "api/asset/scan-barcode/<str:tag_id>",
        api_views.Scan_api_barcode.as_view(),
        name="scan_barcode",
    ),
    path(
        "api/asset/details/update-asset-status/<uuid:id>",
        api_views.UpdateAssetStatus.as_view(),
        name="update_asset_status",
    ),
    path(
        "api/asset/details/assign-asset/<uuid:id>",
        api_views.AssignAsset.as_view(),
        name="assign_asset",
    ),
    path(
        "api/asset/details/unassign-asset/<uuid:id>",
        api_views.UnAssignAsset.as_view(),
        name="unassign_asset",
    ),
    path(
        "api/asset/details/user-list-for-assign-asset",
        api_views.UserListForAssignAsset.as_view(),
        name="user_list_for_assign_asset",
    ),
    path(
        "api/asset/get-notifications",
        api_views.GetNotifications.as_view(),
        name="get_notifications",
    ),
    # path('api/asset/push-notification/',api_views.get_push_notification, name='push_notification'),
    path(
        "api/asset/get_firebase_token/<str:token>",
        notifications_api_view.save_firebase_token,
        name="get_firebase_token",
    ),
    path(
        "api/asset/mark-notification-read",
        api_views.MarkNotificationAsSeen.as_view(),
        name="mark_notification_read",
    ),
    path(
        "api/asset/get-warranty-expired-assets-flag/",
