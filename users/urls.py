...
urlpatterns = [
    ...
    path(
        "assigned-assets/<uuid:id>", user_assigned_assets, name="user_assigned_assets"
    ),
    path(
        "render-username/",
        render_format_based_username,
        name="render_format_based_username",
    ),
    path(
        "create-user-notification-type",
        create_user_notification_type,
        name="create_user_notification_type",
    ),
    path(
        "toggle-two-factor-auth", toggle_two_factor_auth, name="toggle_two_factor_auth"
    ),
]
...
user_api_url_patterns = [
    ...
    path(
        "api/user/user-name-info/<uuid:id>",
        GetUserName.as_view(),
        name="user_name_info",
    ),
