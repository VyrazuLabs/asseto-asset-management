...
def notifications_call(user, entity_type, notification_title, notification_text):
    ...
    get_user_notification_types = {
        "email_notification": (
            get_user.email_notification if get_user.email_notification else False
        ),
        "slack_notification": (
            get_user.slack_notification if get_user.slack_notification else False
        ),
        "browser_notification": (
            get_user.browser_notification if get_user.browser_notification else False
        ),
        "inapp_notification": (
            get_user.inapp_notification if get_user.inapp_notification else False
        ),
    }
