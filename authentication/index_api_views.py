    ...
    def post(request):
        try:
            ...
            return Response(
                {
                    "success": True,
                    "message": "Open your authenticator app and scan this QR code to register for authenticator app login. Then use the otp to verify yourself",
                    "data": {
                        "qrcode": qrcode,
...
class AssetData(APIView):
    ...
    def get(self, request):
        try:
            ...
            return api_response(
                data=data, message="asset data for dashboard get successfully"
            )
...
class UsersData(APIView):
    ...
    def get(self, request):
        try:
            ...
            return api_response(
                data=data, message="user data for dashboard get successfully"
            )
        except ValueError as e:
            return api_response(status=400, error_message=str(e))
        except Exception as e:
...
class ProductData(APIView):
    ...
    def get(self, request):
        try:
            product_count = Product.undeleted_objects.filter(
                Q(organization=None) | Q(organization=request.user.organization)
            ).count()
            latest_product_list = (
            ...
            return api_response(
                data=data, message="product data for dashboard get successfully"
            )
        except ValueError as e:
            return api_response(status=400, error_message=str(e))
        except Exception as e:
...
class VendorData(APIView):
    ...
    def get(self, request):
        try:
            vendor_count = Vendor.undeleted_objects.filter(
                Q(organization=None) | Q(organization=request.user.organization)
            ).count()
            latest_vendor_list = (
            ...
            return api_response(
                data=data, message="Vendors data for dashboard get successfully"
            )
        except ValueError as e:
            return api_response(status=400, error_message=str(e))
        except Exception as e:
...
class LocationData(APIView):
    ...
    def get(self, request):
        try:
            location_count = Location.undeleted_objects.filter(
                Q(organization=None) | Q(organization=request.user.organization)
            ).count()
            all_location_list = (
            ...
            return api_response(
                data=data, message="Location data for dashboard get successfully"
            )
        except ValueError as e:
            return api_response(status=400, error_message=str(e))
        except Exception as e:
